 ...
 * Problem Statement:
 *
 * We need to create a method called `calculateSquare(int number)` which calculates the square of the
 * given integer number. The method should return the square of the input number.
 *
 * We will write unit tests to verify the correctness of the `calculateSquare()` method. The test cases
...
public class OReadingInputTest {
    ...
    public void testCalculateSquare() {
        ...
        // Problem Statement Test Case 1: Input 5, Expected Output: 25
        int input = 5;
        int expectedOutput = 25;
        int actualOutput = calculator.calculateSquare(input);
        Assertions.assertEquals( expectedOutput, actualOutput);
        
        // Problem Statement Test Case 2: Input -4, Expected Output: 16
        input = -4;
        expectedOutput = 16;
        actualOutput = calculator.calculateSquare(input);
        Assertions.assertEquals( expectedOutput, actualOutput);
        
        // Problem Statement Test Case 3: Input 0, Expected Output: 0
        input = 0;
        expectedOutput = 0;
        actualOutput = calculator.calculateSquare(input);
        Assertions.assertEquals( expectedOutput, actualOutput);
