...
public class JavaFilesToTextTest {

    public static void main(String[] args) {
        String folderName = "regex";
        // Folder containing .java files
        String folderPath = "D:\\workspace\\inhouse-trainings-java-basics\\src\\test\\java\\com\\jh\\iht\\java\\basics\\"+folderName;  // Change this to the folder path containing .java files
        
        // Output file where the content of all .java files will be written
        String outputFile = "D:\\workspace\\inhouse-trainings-java-basics\\src\\main\\resources\\output\\"+folderName+"_test_output.txt";  // Change this to your desired output file
